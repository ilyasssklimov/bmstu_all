...
$\large 5 \cdot 7 = 101 \cdot 111 $

$\large (x^2 + 1)(x^2 + x + 1) = x^4 + x^2 + x^3 + x + x^2 + 1 = 11011$ – *слишком большое*

Приводящий многочлен: $\large x^4 + 1$

Ответ: $\large 5 \cdot 7 = 1010_2 = 10_{10}$
